...
# To convert this code for other models (AT1, AT2, different softening), required info is provided in the code at the appropriate places. 
...
ell = 50.                              # characteristic length
kapa = 1e-7                           # residual stiffness (small tolerance value to avoid singularity in strain energy at phase field = 1)
...
num_elem = 80                                    # number of elements in specimen
